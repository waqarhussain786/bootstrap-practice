...
function App() {
  return (
    ...
    <div className = "row">
      <div className = "col-sm-3 border border-primary rounded h6 text-center">.col-sm-3</div>
      <div className = "col-sm-3 border border-primary rounded h6 text-center">.col-sm-3</div>
      <div className = "col-sm-3 border border-primary rounded h6 text-center">.col-sm-3</div>
      <div className = "col-sm-3 border border-primary rounded h6 text-center">.col-sm-3</div>
    </div>
    ...
    <div className = "row">
      <div className = "col-sm-9 border border-primary rounded h6 text-center">.col-sm-9</div>
      <div className = "col-sm-3 border border-primary rounded h6 text-center">.col-sm-3</div>
    </div>
    <div className = "row">
      <div className = "col-sm-10 border border-primary rounded h6 text-center">.col-sm-10</div>
      <div className = "col-sm-2 border border-primary rounded h6 text-center">.col-sm-2</div>
    </div>
    <div className = "row">
